...
const words = ["Html", "CSS","Javascript", "Python", "Java","SQL","PostgreSQL","GitHub","Markdown"];
...
function loadShow(){
  ...
  for(var i = active + 1; i < items.length; i++){
    stt++;
    items[i].style.transform = `translateX(${stt * 120}px) scale(${1 - 0.2*stt}) perspective(16px)  rotateY(-1deg)`;
